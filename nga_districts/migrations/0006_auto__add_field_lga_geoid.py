...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LGA.geoid'
        db.add_column('nga_districts_lga', 'geoid', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LGA.geoid'
        db.delete_column('nga_districts_lga', 'geoid')
