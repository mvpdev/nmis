...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ColumnRename.xpath'
        db.alter_column('parsed_xforms_columnrename', 'xpath', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))


    def backwards(self, orm):
        
        # Changing field 'ColumnRename.xpath'
        db.alter_column('parsed_xforms_columnrename', 'xpath', self.gf('django.db.models.fields.CharField')(max_length=256, unique=True))
