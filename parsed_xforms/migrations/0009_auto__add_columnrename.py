...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('parsed_xforms_columnrename', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('xpath', self.gf('django.db.models.fields.CharField')(unique=True, max_length=256)),
            ('column_name', self.gf('django.db.models.fields.CharField')(max_length=32)),
        ))
        db.send_create_signal('parsed_xforms', ['ColumnRename'])


    def backwards(self, orm):
        
        # Deleting model 'ColumnRename'
        db.delete_table('parsed_xforms_columnrename')
    ...
    models = {
        ...
        'parsed_xforms.columnrename': {
            'Meta': {'object_name': 'ColumnRename'},
            'column_name': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'xpath': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '256'})
        },
        ...
        'parsed_xforms.instancemodification': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instance': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'modifications'", 'to': "orm['xform_manager.Instance']"}),
