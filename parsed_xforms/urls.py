...
urlpatterns = patterns('',
    ...
    url(r"^export_spreadsheet_/(?P<id_string>[^/\.]*)\.(?P<file_format>\S+)$", views.cached_csv_export),
    ...
    url(r"^hide_field/(?P<instance_id>\d+)/(?P<field_slug>\S+)$", views.hide_instance_field),
